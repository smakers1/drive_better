DirectionsRequest = {
  ...
  travelMode: 'TRANSIT',
  transitOptions: {departureTime: timeDepart},
...
function initialize() {
  ...
  var destination = new google.maps.LatLng(openXCStopLatitude.value, openXCStopLongitude.value);
  var mapOptions = {
    zoom: 13,
...
function computeTotalTime(result) {
  ...
  totalTransitTime = total / 60.
  document.getElementById("total").innerHTML = totalTransitTime + " minutes";
}
